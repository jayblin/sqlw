...
typedef std::tuple<
    ...
    std::function<std::error_code(sqlw::Statement&)>, // testee
    sqlw::status::Condition,                          // expected_return_code
    std::string_view                                  // expected_state
    >
    test_case_t;

class StatementTest : public testing::TestWithParam<test_case_t>
{
  public:
...
sqlw::Connection StatementTest::db_con;

TEST_P(StatementTest, can_be_invoked)
{
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        test_case_t{
            "A",
            [](sqlw::Statement& stmt) {
                return stmt("INSERT INTO user (id, name) VALUES (3,'bob')");
            },
        ...
        test_case_t{
            "A0",
            [](sqlw::Statement& stmt) {
                return stmt("INSERT INTO user (id, ) VALUES (3,'bob')");
            },
        ...
        test_case_t{
            "A3",
            [](sqlw::Statement& stmt) {
                return stmt("INSERT INTO user (id, name) VALUES (2,'bob')");
            },
            sqlw::status::Condition::ERROR,
            "1,kate,2,eris,",
        },
        ...
        // Passing sql string + array of parameters to bind. Multiple
        // statements. Non-fatal error in second statement.
        test_case_t{
            "B3",
            [](sqlw::Statement& stmt) {
                return stmt(
        ...
        test_case_t{
            ...
            "1,kate,2,Neddy,3,Bobster,6,Ned,"},
        // Passing sql string + array of parameters to bind + callback. Multiple
        // statements. Error with a parameter for second statement.
        test_case_t{
            "F5",
            [](sqlw::Statement& stmt) {
                std::stringstream ss;
        ...
        test_case_t{
            ...
            sqlw::status::Condition::ERROR,
            "1,kate,2,eris,3,Bob,6,Ned,"}),
    [](const testing::TestParamInfo<StatementTest::ParamType>& info) {
